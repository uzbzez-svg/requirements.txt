...
WEBHOOK_URL = os.getenv("WEBHOOK_URL", "https://api.telegram.org/8831278254:AAEMAByBTcSA2nZVc4iwa4HZ94OKwHgmc9c/setWebhook?url=https://requirements-txt-th8.onrender.com/webhook").strip()
